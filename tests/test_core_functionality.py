...
from schemas.login import JWTPayload, CredentialsSchema
...
class TestUtilityFunctions:
    ...
    def test_sensitive_word_filter_basic(self):
        ...
        try:
            ...
            # 测试基本检测
            text = "这是一个正常的文本"
            contains_sensitive, found_word = filter_instance.contains_sensitive_word(text)
